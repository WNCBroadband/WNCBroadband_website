...
<head>
    ...
    <script>
        ...
        function save_question(evt) {
          ...
          xhttp.open("GET", "../save_question.php?uuid="+uuid+"&name="+this.name+"&value="+this.value+"&survey_id=8&type="+this.type,true);
          xhttp.send();
          update_geo();
        }
     	...
     	<div class="mx-auto col-lg-8">
        	...
        	<div class="form-group">
          		<form id="fullsurvey" class="form" method="POST" action="save_survey.php"> 
                    ...
                    echo '<INPUT type="hidden" name="survey_id" value="8">';                    
                    $sql = "
                    ...
                    <script>
                    	...
                    	function showPosition(position) {
                    		...
                    		var xhttp = new XMLHttpRequest();
                     		 ...
                     		 xhttp.open("GET", "../save_question.php?uuid="+uuid+"&survey_id=8&geoip_latitude="+position.coords.latitude+"&geoip_longitude="+position.coords.longitude,true);
                      		xhttp.send();
                    	}
                    </script>
