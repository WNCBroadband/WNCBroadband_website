...
s.onupdate=function(data){ //callback to update data in UI
    ...
    //parent.document.getElementById("libreUploadResult").innerHTML=myULResult;
    //^use this line if you want to make parent div update dynamically while test is running.
