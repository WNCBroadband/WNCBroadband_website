		...
		<div id="survey-bg" class="row">
			<div class="col-lg-6 mx-auto">
				<div class="form-group">
			    	<form class="form">
			      		<h3>Does your household currently subscribe to a broadband internet service provider?</h3>
			      		<br>
			      		<a class="btn btn-primary btn-lg mt-auto mb-5" href="take_survey.php">Yes</a>
			      		<br>
			      		<a class="btn btn-primary btn-lg mt-auto mb-5" href="take_survey_q10.php"> No </a>
		        	</form>
		      	</div>
			</div>
