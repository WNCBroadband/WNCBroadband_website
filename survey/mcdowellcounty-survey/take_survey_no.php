...
<head>
    ...
    <script>
        ...
        function save_question(evt) {
          ...
          xhttp.open("GET", "../save_question.php?has_broadband=0&uuid="+uuid+"&name="+this.name+"&value="+this.value+"&survey_id=14&type="+this.type,true);
          xhttp.send();
          update_geo();
        }       
                        ...
                        <script>
                        	...
                        	function showPosition(position) {
                        		...
                        		var xhttp = new XMLHttpRequest();
                         		 ...
                         		 xhttp.open("GET", "../save_question.php?has_broadband=0&uuid="+uuid+"&survey_id=14&geoip_latitude="+position.coords.latitude+"&geoip_longitude="+position.coords.longitude,true);
                          		xhttp.send();
                        	}
                        </script>
