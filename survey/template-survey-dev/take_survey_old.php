        	...
        	<div class="form-group">
          		<form id="fullsurvey" class="form" method="POST" action="save_survey.php"> 
                	...
                	<script type="text/javascript">
             			function getResults(up, down){
                	 		console.log("upload speed is: " + up);
     	            		console.log("upload speed is: " + down);
        	     		}
            	 		function doParentFunc(){
                	 		alert("doParentFunc was called from the iframe.");
             			}
            	    </script>            
            		<br><br>
                    <h4>Please Input your Download Speed from the Speed Test:</h4>
            		...
            		<br><br>
           			<h4>From the results of the speed test, explore the capabilities of your download speed with the speeds needed for various applications using the slider below.</h4><br>
                    <div class="slidecontainer">
