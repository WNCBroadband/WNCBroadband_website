...
<body onLoad="createOnLoad()">
	...
	<?php include("http://wncbroadband.org/includes/nav_main_survey.php");?> <!-- include main navigation -->
        	...
        	<div class="form-group">
          		<form id="fullsurvey" class="form" method="POST" action="save_survey.php"> 
    				...
    				<DIV id="hidden_address_block" style="display:none">
          			...
          			<br><br>
          			<div class="q-break"></div><br>
            		<h4>10&#41; There are major issues in broadband delivery concerning where broadband is available and what the actual speeds are delivered by providers. We are working on ways to determine the speeds in your area. Please help us by using the <b>Libre</b> speed test and reporting your results using the sliders below.</h4><br>
           			<iframe height="400px" src="https://wncbroadband.org/speedtestslim_elias/singleServer-progressBar.html" width="100%"></iframe>
            		<p class="small text-center">If the speed test does not show up, click <a href="http://wncbroadband.org/speedtest/singleServer-pretty-minimal.html" target="_blank"> here </a> to open it in a new tab.<b>change me later</b></p>
            
            		<p>Test area for sending data from speedtest iframe up to parent document:</p>
                    Download Result: <div id="libreDownloadResult"></div> <!-- this div id innerhtml is changed from the speedtest page after test concludes -->
                    Upload Result: <div id="libreUploadResult"></div><br>
                	<script type="text/javascript">
             			function getResults(down, up){
     	            		...
     	            		//add code here to send results to database automatically
        	     		}
            	    </script>            
            		<br><br>
...
<!--               			<input id="downslider" name="SPEEDTEST__libre_speed-test__download" type="range" class="js-range-slider slider" min="1" max="200" step="0.1" value="1" data-rangeslider> -->
           			   <p class="text-center lead">Download Speed <input id="downtextbox" type="text" class="js-input" name="SPEEDTEST__libre_speed_test__download" id="downloadspeedval-libredemo" class="text" maxlength="5" size="5"> Mbps</p>
            		</div>
...
<!--               			<input id="upslider"  name="SPEEDTEST__libre_speed_test__upload" type="range" class="js-range-slider slider" min="1" max="200" step="0.1" value="1" data-rangeslider> -->
             			<p class="text-center lead">Upload Speed <input id="uptextbox" type="text" class="js-input" name="SPEEDTEST__libre_speed_test__upload" id="uploadspeedval-libredemo" class="text" maxlength="5" size="5"> Mbps</p>
            		</div>
            		<br><br>
           			<h4>Based on the results of the speed test, your download speeds allows you the following capabilities of various applications:</h4><br>
                    <div class="slidecontainer">
