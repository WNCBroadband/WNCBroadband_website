...
<!-- <nav class="navbar navbar-expand-md bg-lblue navbar-dark communitynav">
	...
	<section class="p-5 bg-light">
		<div id="survey-bg" class="row">
			<div class="col-lg-6 mx-auto">
				<div class="form-group">
			    	<form class="form">
			      		<h3>Does your household currently subscribe to Internet services?</h3>
			      		<br>
			      		<a class="btn btn-primary mt-auto mb-5" href="take_survey.php">Yes</a>
			      		<br>
			      		<a class="btn btn-primary mt-auto mb-5" href="survey-end.php"> No (or cell phone is the only source for your internet)</a>
		        	</form>
		      	</div>
			</div>
			<div class="my-auto showcase-text offset-lg-3 survey-bg col-lg-6">
			</div>
		</div>	
	</section>
