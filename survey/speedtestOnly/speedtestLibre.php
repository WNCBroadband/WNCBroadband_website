...
<head>
    ...
    <!-- Bootstrap core CSS -->
  	<link href="http://www.wncbroadband.org/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- JQuery -->
  	<script src="http://www.wncbroadband.org/vendor/jquery/jquery.min.js"></script> 
    <!-- Bootstrap core CSS -->
  	<link href="http://www.wncbroadband.org/vendor/bootstrap/css/bootstrap.css" rel="stylesheet">
    <!-- Custom fonts for this template -->
  	<link href="https://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic,700italic" rel="stylesheet" type="text/css">
    <!--Site Stylesheet-->
  	<link href="http://www.wncbroadband.org/css/style.css" rel="stylesheet" type="text/css">
	...
	<script src="http://wncbroadband.org/survey/speedtestslider.js"></script>
    <script>
        var response_id = -10;
