   <!-- Navigation -->
	<nav class="navbar navbar-expand-lg bg-dblue navbar-dark mainnav">
     	<a class="navbar-brand" href="https://wncbroadband.org/blog">
        	<img src="https://wncbroadband.org/img/wncbroadbandlogo.png" alt="WNC Broadband Project Logo Image and Link" class="img-fluid logo">
      	</a>
		...
		<div class="collapse navbar-collapse navbars pull-right" id="navbar1">
        	<ul class="navbar-nav ml-auto small">
              	...
              	<li class="nav-item">
                	<a class="nav-link" href="https://wncbroadband.org/aboutproject.php">About</a>
              	</li>
              	<li class="nav-item">
