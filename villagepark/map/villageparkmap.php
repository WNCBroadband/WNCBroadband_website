...
<nav class="navbar navbar-expand-md bg-lblue navbar-dark communitynav2">
 ...
 <div class="collapse navbar-collapse navbars" id="navbar2">
        <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" href="../index.html">Village Park</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="../aboutVillagePark.html">About Community</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="../../survey/villagepark-survey/survey.html">Survey</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <li><a class="dropdown-item" href="villageparkmap.php">Speed Test Results</a></li>
...
<!--  <div id="mapKey">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    ...
    echo '<script src="survey_data.php?survey_id=3"></script>';
        }
    ?>
    <script  src="villageparkmapScript.js"></script>
